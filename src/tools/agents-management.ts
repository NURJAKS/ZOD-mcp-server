...
export function registerAgentsManagement({ mcp }: McpToolContext): void {
  // agents_management - Unified agent management tool
  mcp.tool(
    'agents_management',
    'Unified agent management tool with 10 functions: launch, assign roles, execute tasks, get status, communicate, get messages, get notifications, clear notifications, get collaboration status, coordinate agents',
    {},
    async () => {
      try {
        fleet.launch()
